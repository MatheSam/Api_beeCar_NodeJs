...
export class nomeDaMigration1662414587285 implements MigrationInterface {
    name = 'nomeDaMigration1662414587285'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "automatic" boolean NOT NULL DEFAULT false, "type" character varying(20) NOT NULL, "airCondioting" boolean NOT NULL DEFAULT true, "directionType" character varying(50) NOT NULL, "powerWindows" boolean NOT NULL, "pricePerDay" numeric(12,2) NOT NULL, "pricePerWeekend" numeric(12,2) NOT NULL, "pricePerMouth" numeric(12,2) NOT NULL, "pricePeryear" numeric(12,2) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_8b0be371d28245da6e4f4b61878" UNIQUE ("name"), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cars" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "licensePlate" character varying(7) NOT NULL, "color" character varying(50) NOT NULL, "model" character varying(50) NOT NULL, "fuel" character varying(1) NOT NULL, "year" integer NOT NULL, "brand" character varying(50) NOT NULL, "rented" boolean NOT NULL DEFAULT false, "document" boolean NOT NULL DEFAULT true, "isActive" boolean NOT NULL DEFAULT true, "price" numeric(12,2) NOT NULL, "km" numeric(12,2) NOT NULL, "hp" integer NOT NULL, "maintenence" boolean NOT NULL DEFAULT false, "img" character varying NOT NULL, "categoriesId" uuid, CONSTRAINT "UQ_1df40c87717e8631a39fd42920a" UNIQUE ("licensePlate"), CONSTRAINT "PK_fc218aa84e79b477d55322271b6" PRIMARY KEY ("id"))`);
