...
export class beecar1662406223190 implements MigrationInterface {
    name = 'beecar1662406223190'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "automatic" boolean NOT NULL DEFAULT false, "type" character varying(20) NOT NULL, "airCondioting" boolean NOT NULL DEFAULT true, "directionType" character varying(50) NOT NULL, "powerWindows" boolean NOT NULL, "pricePerDay" numeric(12,2) NOT NULL, "pricePerWeekend" numeric(12,2) NOT NULL, "pricePerMouth" numeric(12,2) NOT NULL, "pricePeryear" numeric(12,2) NOT NULL, CONSTRAINT "UQ_8b0be371d28245da6e4f4b61878" UNIQUE ("name"), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "maintenence" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "PK_6b1066b9a8c32ca556e0a817a84" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "rent" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "initialDate" date NOT NULL, "initialHour" TIME NOT NULL, "finalDate" date NOT NULL, "finalHour" date NOT NULL, "totalValue" numeric(12,2) NOT NULL, "usersId" uuid, "carsId" uuid, CONSTRAINT "PK_211f726fd8264e82ff7a2b86ce2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cars" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "licensePlate" character varying(7) NOT NULL, "color" character varying(50) NOT NULL, "model" character varying(50) NOT NULL, "fuel" character varying(1) NOT NULL, "year" integer NOT NULL, "brand" character varying(50) NOT NULL, "rented" boolean NOT NULL DEFAULT false, "document" boolean NOT NULL DEFAULT true, "price" numeric(12,2) NOT NULL, "km" numeric(12,2) NOT NULL, "hp" integer NOT NULL, "categoriesId" uuid, "maintenenceId" uuid, CONSTRAINT "UQ_1df40c87717e8631a39fd42920a" UNIQUE ("licensePlate"), CONSTRAINT "REL_0445f6e14ac9cb304ecc8716b2" UNIQUE ("maintenenceId"), CONSTRAINT "PK_fc218aa84e79b477d55322271b6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_84cdcf05ce244ce7797bd7e65f3" FOREIGN KEY ("cnhId") REFERENCES "cnh"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "cars" ADD CONSTRAINT "FK_0445f6e14ac9cb304ecc8716b2c" FOREIGN KEY ("maintenenceId") REFERENCES "maintenence"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "cars" DROP CONSTRAINT "FK_0445f6e14ac9cb304ecc8716b2c"`);
        ...
        await queryRunner.query(`DROP TABLE "maintenence"`);
