...
export class beecar1662411300924 implements MigrationInterface {
    name = 'beecar1662411300924'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cars" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "licensePlate" character varying(7) NOT NULL, "color" character varying(50) NOT NULL, "model" character varying(50) NOT NULL, "fuel" character varying(1) NOT NULL, "year" integer NOT NULL, "brand" character varying(50) NOT NULL, "rented" boolean NOT NULL DEFAULT false, "document" boolean NOT NULL DEFAULT true, "price" numeric(12,2) NOT NULL, "km" numeric(12,2) NOT NULL, "hp" integer NOT NULL, "maintenence" boolean NOT NULL DEFAULT false, "categoriesId" uuid, CONSTRAINT "UQ_1df40c87717e8631a39fd42920a" UNIQUE ("licensePlate"), CONSTRAINT "PK_fc218aa84e79b477d55322271b6" PRIMARY KEY ("id"))`);
