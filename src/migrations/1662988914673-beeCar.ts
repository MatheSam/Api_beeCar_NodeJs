...
export class beeCar1662988914673 implements MigrationInterface {
    name = 'beeCar1662988914673'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "automatic" boolean NOT NULL DEFAULT false, "type" character varying(20) NOT NULL, "airConditioning" boolean NOT NULL DEFAULT true, "directionType" character varying(50) NOT NULL, "powerWindows" boolean NOT NULL, "pricePerDay" numeric(12,2) NOT NULL, "pricePerWeekend" numeric(12,2) NOT NULL, "pricePerMouth" numeric(12,2) NOT NULL, "pricePeryear" numeric(12,2) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_8b0be371d28245da6e4f4b61878" UNIQUE ("name"), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`);
